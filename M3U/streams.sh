...
sed -i "/HOT\/index.fmp4.m3u8/ c https://moonlight.wideiptv.top/HOT/index.fmp4.m3u8?token=$(curl -s "http://popcdn.day/play.php?stream=HOT" | sed -n 's/.*src="[^"]*token=\([^&"]*\).*/\1/p')" M3UPT/M3UPT.m3u
