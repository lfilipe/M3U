...
sed -i "/Canal11/ c https://love2live.wideiptv.top/Canal11/index.fmp4.m3u8?token=$(curl -s \"http://popcdn.day/play.php?stream=Canal11\" | sed -n 's/.*src=\"[^\"]*token=\([^\&\"]*\).*/\1/p')" M3UPT.m3u
